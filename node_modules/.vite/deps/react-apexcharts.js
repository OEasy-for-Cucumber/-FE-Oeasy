...
var require_react_apexcharts_min = __commonJS({
  "node_modules/react-apexcharts/dist/react-apexcharts.min.js"(exports) {
      ...
      if (e !== t) {
        ...
        if (!r.has(e) && !r.has(t)) {
          ...
          for (var i = 0, u = n; i < u.length; i++) {
            var p = u[i];
            if (!o.includes(p) || !deepEqual(e[p], t[p], r)) return false;
          }
        }
      }
      return true;
    ...
    function Charts(e) {
      ...
      var t = e.type, r = void 0 === t ? "line" : t, t = e.width, n = void 0 === t ? "100%" : t, t = e.height, i = void 0 === t ? "auto" : t, u = e.series, p = e.options, t = _objectWithoutProperties(e, _excluded), c = (0, _react.useRef)(null), a = (0, _react.useRef)(null), f = ((0, _react.useEffect)(function() {
        var e2 = c.current;
        return a.current = new _apexcharts.default(e2, f()), a.current.render(), function() {
          a.current && "function" == typeof a.current.destroy && a.current.destroy();
        };
      }, []), (0, _react.useEffect)(function() {
        var e2 = a.current.options, t2 = !deepEqual(a.current.series, u), e2 = !deepEqual(e2, p) || i !== a.current.height || n !== a.current.width;
        (t2 || e2) && (!t2 || e2 ? a.current.updateOptions(f()) : a.current.updateSeries(u));
      }, [p, u, i, n]), function() {
        return s(p, { chart: { type: r, height: i, width: n }, series: u });
      }), s = function(t2, r2) {
        var n2 = _objectSpread({}, t2);
        return o(t2) && o(r2) && Object.keys(r2).forEach(function(e2) {
          o(r2[e2]) && e2 in t2 ? n2[e2] = s(t2[e2], r2[e2]) : Object.assign(n2, _defineProperty({}, e2, r2[e2]));
        }), n2;
      }, e = omit(t, Object.keys(Charts.propTypes));
      return _react.default.createElement("div", _extends({ ref: c }, e));
    }
