...
const OeVote: FC<scrollRefProps> = ({ scrollRef }) => {
  ...
  return (
    <section className="flex flex-col justify-center items-start h-[calc(100vh-56px)] xl:h-[calc(100vh-80px)] px-6 xl:p-0">
      ...
      <div className={`${animation.animationOne ? "animate-fade-in-up" : "opacity-0"} w-full transition-opacity`}>
      ...
      <div className={`${animation.animationTwo ? "animate-fade-in-up" : "opacity-0"} w-full xl:w-[512px] mx-auto`}>
