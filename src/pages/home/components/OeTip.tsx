...
const OeTip: FC<scrollRefProps> = ({ scrollRef }) => {
  ...
  return (
    <section className="flex flex-col items-center justify-center h-[calc(100vh-56px)] xl:h-[calc(100vh-80px)] px-[35px] xl:p-0">
      ...
      <div
        className={`${animation.animationOne ? "animate-fade-in-up will-change-[opacity,transform]" : "opacity-0"} w-[281px] transition-opacity xl:w-full mx-auto`}
      >
      ...
      {tipList && (
        <div
          className={`${animation.animationTwo ? "animate-fade-in-up will-change-[opacity,transform]" : "opacity-0"} transition-opacity`}
        >
