...
function AiOe() {
  ...
  return (
    <>
      ...
      />
      {aiOe && (
        <div className="fixed w-full min-w-[360px] max-w-[520px] h-screen xl:hidden bg-grayoe-950 z-50">
          ...
          <div className="h-[calc(100vh-56px)] xl:h-[calc(100vh-80px)] px-6">
            ...
            {messages?.map((mes, index) => (
              <div key={index} className="mb-4">
                {mes.sender === "user" ? (
                  ...
                  <div>
                    <div className="flex justify-start">
                      <img src={aioeIcon} alt="Profile" className="w-10 h-10 rounded-full mr-2 border border-white" />
                      <div className="flex flex-col gap-1 max-w-[180px] min-w-[20px]">
                        <p className="font-semibold">AI OE</p>
                        <div className="bg-grayoe-600 rounded-r-xl rounded-bl-xl px-3 py-2 text-white break-words whitespace-pre-wrap">
                          {mes.content}
