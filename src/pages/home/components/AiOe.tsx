    ...
    <>
      ...
      {aiOe &&
        ReactDOM.createPortal(
          <div className="fixed left-1/2 xl:left-auto transform xl:transform-none -translate-x-1/2 xl:right-[80px] bottom-0 xl:bottom-[152px] w-full min-w-[360px] max-w-[520px] h-[calc(var(--vh, 1vh) * 100)] xl:w-[390px] xl:h-[600px] bg-grayoe-950 z-50 xl:rounded-2xl">
