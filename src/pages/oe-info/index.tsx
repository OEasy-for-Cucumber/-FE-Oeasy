...
function OeInfo() {
  return (
    <>
      <div>
        <div className="font-LuckiestGuy bg-info_cucumber w-full h-[480px] xl:h-[400px] bg-cover bg-center bg-no-repeat flex justify-center items-center text-[60px] xl:text-[80px]">
          <p>cucumber</p>
        </div>
        <div className="w-full flex flex-col">
          <div className=" mx-6 xl:w-[1040px] my-20 flex flex-col gap-[104px] xl:mx-auto">
            <div className="w-full flex flex-col xl:h-[196px]">
              <p className="mx-auto font-h3 text-greenoe-600 mb-10">오이의 효능</p>
              <p className="mb-5">
            ...
            <div className="w-full flex flex-col">
              <p className="mx-auto font-h3 text-greenoe-600 mb-16">오이 품종</p>
              <div className="flex flex-col">
                <div className="flex-1 xl:flex xl:justify-between">
                  <p className="font-h4">백다다기 오이</p>
                  <div className="flex flex-col xl:w-[688px]">
                    <img src={dadagi} alt="백다다기 오이" className="w-full h-[312px] rounded-lg my-6 xl:mt-0" />
                    <div className="font-b1-semibold flex flex-col gap-5">
                      <p>
                ...
                <div className="mt-12 flex-1 xl:flex xl:justify-between">
                  <p className="font-h4">취청 오이</p>
                  <div className="flex flex-col xl:w-[688px]">
                    <img src={dadagi} alt="취청 오이" className="w-full h-[312px] rounded-lg my-6 xl:mt-0" />
                    <div className="font-b1-semibold flex flex-col gap-5">
                      <p>
                ...
                <div className="mt-12 flex-1 xl:flex xl:justify-between">
                  <p className="font-h4">가시 오이</p>
                  <div className="flex flex-col xl:w-[688px]">
                    <img src={dadagi} alt="가시 오이" className="w-full h-[312px] rounded-lg my-6 xl:mt-0" />
                    <div className="font-b1-semibold flex flex-col gap-5">
                      <p>
                        가시오이는
            ...
            <div className="w-full flex flex-col">
              <p className="mx-auto font-h3 text-greenoe-600 mb-10">오이의 성장과정</p>
            </div>
          </div>
        </div>
      </div>
