        ...
        <div className=" mx-6 xl:w-[1040px] mt-20 flex flex-col gap-[104px] xl:mx-auto">
          <div className="w-full h-auto flex flex-col ">
            ...
            <p className="mb-5 font-b1-semibold xl:font-h5" ref={addToRefs}>
              ...
              도움이 되고 나트륨의 배출도 돕습니다. 이때 체내의 중금속도 함께 배출 되어 피를 맑게 하는 효과가 있습니다.
            </p>
                ...
                <div className="flex flex-col xl:w-[700px]">
                  ...
                  <div className="font-b1-semibold xl:font-h5 flex flex-col gap-5">
                    <p ref={addToRefs}>
                      ...
                      <span className="text-greenoe-600"> 연한 녹색을 띠며 씨가 적고 단단해 저장성이 뛰어납니다.</span>
                    </p>
                    <p ref={addToRefs}>
                      이러한 특징 덕분에
                ...
                <div className="flex flex-col xl:w-[688px]">
                  ...
                  <div className="font-b1-semibold xl:font-h5 flex flex-col gap-5">
                    <p ref={addToRefs}>
                      ...
                      <span className="text-greenoe-600"> 가시가 적고 표면이 매끄러운 것</span>이 특징입니다. 주로 호남
                      지역에서 생산되며 추위에 강해 겨울철에도 재배가 용이합니다.
                    </p>
                    <p ref={addToRefs}>
                      껍질이 단단하고 씨가 적어
                      <span className="text-greenoe-600"> 생으로 먹기에 적합한 품종으로 냉면 고명이나 냉국 재료</span>로
                      많이 활용됩니다. 밝은 청록색의 외관과 무른 속살 덕분에 여름철 상큼한 요리에 자주 사용됩니다.
                    </p>
                    <p ref={addToRefs}>
              ...
              <div className="flex-1 xl:flex xl:justify-between">
                ...
                <div className="flex flex-col xl:w-[688px]">
                  ...
                  <div className="font-b1-semibold xl:font-h5 flex flex-col gap-5">
                    <p ref={addToRefs}>
                      가시오이는
                      <span className="text-greenoe-600"> 짙은 녹색과 겉면의 많은 가시, 주름</span>이 특징인 오이입니다.
                      껍질은 얇고 속살은 아삭아삭해 씹는 맛이 좋아 무침, 냉채, 샐러드 등 다양한 요리에 활용됩니다.{" "}
                    </p>
                    <p ref={addToRefs}>
          ...
          <div className="w-full flex flex-col">
            ...
            <div className="grid grid-cols xl:grid-cols-2 gap-y-16 xl:gap-y-24 max-w-7xl relative font-b1-semibold xl:font-h6">
              ...
              <div
                className="w-[312px] xl:w-[668px] justify-self-center xl:col-start-2 xl:mt-[450px] xl:mr-[400px]"
                ref={addToRefs}
              >
                <img
                  src={growOE6}
