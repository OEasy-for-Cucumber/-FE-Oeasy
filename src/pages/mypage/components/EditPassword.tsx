  ...
  return (
    <div className={`modal ${isModalVisible ? "open" : ""} z-50`}>
      ...
      <form
        ...
        className="bg-grayoe-950 text-white w-full min-w-[360px] max-w-[520px] xl:max-w-none xl:w-[512px] relative h-svh xl:h-[400px] xl:rounded-2xl xl:px-6 xl:py-6 px-6 pb-[40px] flex flex-col"
      >
        ...
        <div className="grid">
          ...
          {isPasswordValid === false && newPassword !== "" && (
            <p className="mt-1 text-[12px] redoe">영문, 숫자, 특수문자를 포함하여 8자 이상 입력해주세요.</p>
          )}
        </div>
        ...
        <div className="mt-auto xl:mt-auto">
          <Button size="large" isActive={isPasswordMatch}>
            완료
          </Button>
        </div>
      </form>
